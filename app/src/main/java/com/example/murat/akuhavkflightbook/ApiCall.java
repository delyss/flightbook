...
class ApiCall extends StringRequest {
    private static final String API_URL = "http://tty.tc/e2a53f56-32ba-49ee-947e-53f9f16bf2fe/api/adduser.php";
    private Map<String, String> params;

    ApiCall(String firstName, String lastName, String email, String phone, String password, Response.Listener<String> listener) {
